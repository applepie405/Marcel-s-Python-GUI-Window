...
radio1 = ttk.Radiobutton(frame4, variable=radio_var, text="Red", value="red")
radio1.grid(row=0, column=0)
radio2 = ttk.Radiobutton(frame4, variable=radio_var, text="Green", value="green")
radio2.grid(row=0, column=1)
radio3 = ttk.Radiobutton(frame4, variable=radio_var, text="Blue", value="blue")
